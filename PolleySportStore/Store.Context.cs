...
namespace PolleySportStore
{
    ...
    public partial class StoreEntities : DbContext
    {
        ...
        public virtual int CategoryName(Nullable<int> cat_Id)
        {
            var cat_IdParameter = cat_Id.HasValue ?
                new ObjectParameter("Cat_Id", cat_Id) :
                new ObjectParameter("Cat_Id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CategoryName", cat_IdParameter);
        }
    
        public virtual int Content_View()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Content_View");
        }
    
        public virtual int ContentView()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ContentView");
        }
    
        public virtual int CreateOrderCart(Nullable<int> productID, Nullable<int> orderID, string name, Nullable<double> price, Nullable<int> quantity, Nullable<int> sizeID, string sizeDescription)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CreateOrderCart", productIDParameter, orderIDParameter, nameParameter, priceParameter, quantityParameter, sizeIDParameter, sizeDescriptionParameter);
        }
    
        public virtual int CreatOrderCart(Nullable<int> productID, Nullable<int> orderID, string name, Nullable<double> price, Nullable<int> quantity)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("ProductID", productID) :
                new ObjectParameter("ProductID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("CreatOrderCart", productIDParameter, orderIDParameter, nameParameter, priceParameter, quantityParameter);
        }
    
        public virtual int Events_View()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Events_View");
        }
    
        public virtual int Gallery_Edit(Nullable<int> galleryID, string name, string imageURL)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Gallery_Edit", galleryIDParameter, nameParameter, imageURLParameter);
        }
    
        public virtual int Gallery_Insert(string galleryTitle, string galleryImageURL)
        {
            var galleryTitleParameter = galleryTitle != null ?
                new ObjectParameter("GalleryTitle", galleryTitle) :
                new ObjectParameter("GalleryTitle", typeof(string));
    
            var galleryImageURLParameter = galleryImageURL != null ?
                new ObjectParameter("GalleryImageURL", galleryImageURL) :
                new ObjectParameter("GalleryImageURL", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Gallery_Insert", galleryTitleParameter, galleryImageURLParameter);
        }
    
        public virtual int Gallery_Update(Nullable<int> galleryID, string galleryTitle, string galleryContent, string galleryImageURL, Nullable<bool> galleryInactive)
        {
            var galleryIDParameter = galleryID.HasValue ?
                new ObjectParameter("GalleryID", galleryID) :
                new ObjectParameter("GalleryID", typeof(int));
            ...
            var galleryContentParameter = galleryContent != null ?
                new ObjectParameter("GalleryContent", galleryContent) :
                new ObjectParameter("GalleryContent", typeof(string));
    
            var galleryImageURLParameter = galleryImageURL != null ?
                new ObjectParameter("GalleryImageURL", galleryImageURL) :
                new ObjectParameter("GalleryImageURL", typeof(string));
    
            var galleryInactiveParameter = galleryInactive.HasValue ?
                new ObjectParameter("GalleryInactive", galleryInactive) :
                new ObjectParameter("GalleryInactive", typeof(bool));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Gallery_Update", galleryIDParameter, galleryTitleParameter, galleryContentParameter, galleryImageURLParameter, galleryInactiveParameter);
        }
    
        public virtual int Gallery_view()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Gallery_view");
        }
    
        public virtual int Gallery_view_search(string title)
        {
            var titleParameter = title != null ?
                new ObjectParameter("Title", title) :
                new ObjectParameter("Title", typeof(string));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Gallery_view_search", titleParameter);
        }
    
        public virtual int Product_Attributes_Prices(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("Id", id) :
                new ObjectParameter("Id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("Product_Attributes_Prices", idParameter);
        }
    
        public virtual int ProductSizeRange(Nullable<int> productID)
        {
            var productIDParameter = productID.HasValue ?
                new ObjectParameter("ProductID", productID) :
                new ObjectParameter("ProductID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ProductSizeRange", productIDParameter);
        }
    }
}
